                            ...
                            {!formToggle ?
                                ...
                                : <div className={Style.formWrap}>
                                    <form action="" onSubmit={(e) => { SignUpHandler(e) }}>
                                            ...
                                            <div className={Style.flex_row} >
                                                <div className={Style.radioForm}>
                                                    <input
                                                        type="radio"
                                                        name="Home"
                                                        checked={locType === 'Home'}
                                                        onChange={() => setLocType('Home')}
                                                    />
                                                    <label> Home </label>
                                                </div>
                                            </div>
                                            <div className={Style.flex_row} >
                                                <div className={Style.radioForm}>
                                                    <input
                                                        type="radio"
                                                        name="Office"
                                                        checked={locType === 'Office'}
                                                        onChange={() => setLocType('Office')}
                                                    />
                                                    <label> Office </label>
                                                </div>
                                            </div>
                                        ...
                                        <button className={Style.button_submit}> Save </button >
                                        <button className={Style.button_submit} onClick={() => setFormToggle(false)}> Cancel </button >
                                    </form >
                                </div >
                            }
                        ...
                        <div className={Style.modal}>
                            <form className={Style.form}>
                                <div className={Style.payment_options}>
                                    <button name={Style.paypal} type="button" >
                                        <svg viewBox="0 0 124 33" height="33px" width="124px" y="0px" x="0px" id="Layer_1" version="1.1" >
                                    ...
                                    <button type="button">
                                        <svg viewBox="0 0 512 210.2" y="0px" x="0px" id="Layer_1" version="1.1">
                                ...
                                <div className={Style.credit_card_info_form}>
                                    <label for="password_field" className={Style.input_label}>Card holder full name</label>
                                    <div className={Style.inputForm}>
                                        <input id="password_field" className={Style.input} type="text" name="input-name" title="Inpit title" placeholder="Enter your full name" />
                                    </div>
                                    <label for="password_field" className={Style.input_label}>Card Number</label>
                                    <div className={Style.inputForm}>
                                        <input id="password_field" className={Style.input} type="number" name="input-name" title="Inpit title" placeholder="0000 0000 0000 0000" />
                                    </div>
                                    <label for="password_field" className={Style.input_label}>Expiry Date / CVV</label>
                                    <div className={Style.inputForm}>
                                        <div className={Style.split}>
                                            <input id="password_field" className={Style.input} type="text" name="input-name" title="Expiry Date" placeholder="01/23" />
                                            <input id="password_field" className={Style.input} type="number" name="cvv" title="CVV" placeholder="CVV" />
                                        </div>
                                    </div>
                                </div>
